...
but_equal = Button(root, text="=", padx=91, pady=20, command=button_equal)
but_clear = Button(root, text="Clear", padx=79, pady=20, command=button_clear)

but_subtract = Button(root, text="-", padx=40, pady=20, command=button_subtract)
but_multiply = Button(root, text="*", padx=41, pady=20, command=button_multiply)
but_divide = Button(root, text="/", padx=41, pady=20, command=button_divide)
